...
public class AdminUserController {
    ...
    @PostMapping()
    public ResponseEntity<?> createUser(@Valid @RequestBody final AdminUserRequest request) {
        return Helper.createResponseEntity(userService.createUser(request));
    }

    @PutMapping("/{id}")
    public ResponseEntity<?> updateUser(@PathVariable String id, @Valid @RequestBody final AdminUserRequest request) {
