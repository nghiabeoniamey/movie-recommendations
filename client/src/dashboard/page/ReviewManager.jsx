...
import {AdminReviewApi} from "../../api/AdminReview.ts";
import {AdminUserApi} from "../../api/AdminUser.ts";
...
const ReviewManager = () => {
    ...
    return (
        <div className="bg-gray-100 p-4 pt-32 pb-40">
            <div className="max-w-7xl mx-auto">
                ...
                <div className="bg-white p-6 rounded-lg shadow-lg mb-8">
                    ...
                    <div className="mt-4 flex justify-end space-x-2">
                        ...
                        <button
                            className="px-4 py-2 bg-gray-600 text-white rounded-md hover:bg-gray-700 flex items-center transform hover:scale-105 transition-transform">
                    ...
                    {new Date(
                        parseInt(review.createdDate)
                                ...
                                <div className="mt-3 flex gap-2">
                                    <button
                                        className="px-4 py-1.5 text-sm border rounded-lg bg-gray-100 hover:bg-gray-200">
                                        Public Comment
                                    </button>
                                    <button
